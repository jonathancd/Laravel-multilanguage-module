...
@section('content')
    ...
    <div>
        <div class="row">        
          ...
          <form action="{{url('/languages')}}/{{$language->id}}" method="post" class="form-content fadeIn animated">
            {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Iso</label>
                                    <input type="text" name="iso" class="form-control"  value="{{ old('iso', $language->code) }}" placeholder="Example: es,en..">
